...
?>
        ...
        <head>
          <meta charset="utf-8">
            ...
            <title>BOOK STORE LPIP UMP</title>
    ...
    <script type="text/javascript" src="jquery-1.9.1.min.js"></script>
		...
		<body class="hold-transition login-page" style="background-color:#FFF">
            ...
            if(isset($_GET['i'])){
            	...
            	<br>
                <br>
                <a href="?i="><img src="images/logo.png" style="width:600px"></a>
            </center>
            <?php
				}
				else{
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 0895-8004-18277</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> shopeerlpipump@gmail.com</a></li>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="?i="><img src="images/logo.png"></a>
						</div>
					</div>
					<div class="col-sm-8">
