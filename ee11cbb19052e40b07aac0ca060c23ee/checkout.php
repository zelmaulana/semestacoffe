				...
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
                            ...
                            <li>Total Bayar <span>Rp. <?php echo $ha['biaya']+$hrinc['bb']?></span></li><br />
                            <a href="?i=bayar&id=<?php echo md5('byr')?>"><button type="button" class="btn-success" <?php if($na == 0){ echo "disabled"; }else {echo "";}?>>Bayar</button></a>
						</ul>
