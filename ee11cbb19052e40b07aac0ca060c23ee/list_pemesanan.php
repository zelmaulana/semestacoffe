					...
					<div class="category-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#belumbayar" data-toggle="tab">Pesan Menu</a></li>
								<li><a href="#lunas" data-toggle="tab">Proses Menu</a></li>
								...
								<div class="col-sm-12">
									<div class="product-image-wrapper">
										<div class="single-products">
											<center><h2>Tidak Ada Data</h2></center>
										</div>
									</div>
								</div>
                                <?php
									...
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-right">
												<center><h2>Tagihan Pembayaran</h2></center>
