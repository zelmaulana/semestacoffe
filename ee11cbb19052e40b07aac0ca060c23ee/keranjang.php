		...
		<div class="container">
			<div class="row">
                ...
                $srinc = mysqli_query($koneksi, "SELECT SUM(a.jumlah_trx) as aa, SUM(a.total) as bb FROM t_keranjang a
										 		LEFT OUTER JOIN m_barang b on a.brg_id = b.brg_id
												WHERE a.user_id = '$_SESSION[id]' AND pemesanan_id = '0'");
				$aa = mysqli_query($koneksi, "SELECT * FROM t_keranjang 
				...
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
                            ...
                            <a href="?i=chekout"><button type="button" class="btn-success" <?php if($bb == 0){ echo "disabled"; }else {echo "";} ?>>Pesan</button></a> 
                            <!-- <a href="?i=dropshiper"><button type="button" class="btn-success" <?php if($bb == 0){ echo "disabled"; }else {echo "";} ?>>Kirim Sebagai Dropshiper</button></a> -->
						</ul>
