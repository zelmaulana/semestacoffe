			...
			<div class="col-sm-6">
				<div class="total_area">
					<ul>
						...
						<a href="?i=chekout"><button type="button" class="btn-success" <?php if ($bb == 0) {
																							echo "disabled";
																						} else {
																							echo "";
																						} ?>>Pesan</button></a>
						<!-- <a href="?i=dropshiper"><button type="button" class="btn-success" <?php if ($bb == 0) {
																									echo "disabled";
																								} else {
																									echo "";
																								} ?>>Kirim Sebagai Dropshiper</button></a> -->
					</ul>
