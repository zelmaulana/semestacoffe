					...
					<tbody>
                            ...
                            <td>
                                <select name="prop" id="prop" onChange="ajaxkota(this.value)" required>
                                    ...
                                    while ($dataProvinsi=mysqli_fetch_array($queryProvinsi)){
                                        ?><option value="<?php echo $dataProvinsi['propinsi_id']?>"
                                          <?php
						...
						<tr>
                            ...
                            <td><select name="kota" id="kota" onchange="ajaxkec(this.value)" required>
									...
									while($hkota = mysqli_fetch_array($skota)){
										?>
										<option value="<?php echo $hkota['kabupaten_id']?>"
                                        <?php
						...
						<tr>
                            ...
                            <td><select name="kec" id="kec" onChange="ajaxkel(this.value)" required>
									...
									while($hkec = mysqli_fetch_array($skec)){
										?>
										<option value="<?php echo $hkec['kecamatan_id']?>"
                                        <?php
                        ...
                        <tr>
                            ...
                            <td><select name="kel" id="kel" onChange="ajaxkd(this.value)" required>
									...
									?>
                    					<option value="<?php echo $hdes['desa_id']?>"
                                        <?php
						...
						<tr>
                        	<td><input type="submit" name="simpan" id="simpan" class="btn btn-info fa fa-save" value="SIMPAN" />
                            	<a href="?i="><input type="button" name="kembali" id="kembali" class="btn btn-succes fa fa-back" value="KEMBALI" /></a></td>
						</tr>
				</table>
            </form>
			</div>
