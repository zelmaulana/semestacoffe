<?php
if(isset($_POST['add'])){
	mysqli_query($koneksi, "INSERT INTO l_kategori_acc VALUES ('','$_POST[nama]')");
	?>
    <script>
...
if(isset($_POST['updt'])){
	mysqli_query($koneksi, "UPDATE l_kategori_acc SET kategoriacc_nama='$_POST[nama]' WHERE kategoriacc_id = '$_GET[id]'");
	?>
    <script>
	alert("Data Berhasil Disimpan");
	window.location="?i=<?php echo $_GET['i']?>";
...
<!-- Content Wrapper. Contains page content -->
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data Kategori Accessoris
        <small>ADMIN</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-male"></i> Home</a></li>
        <li><a href="#">Tables</a></li>
        <li class="active">Data Kategori Accessoris</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Kategori Accessoris</h3>
            </div>
            <br>
            <!-- /.box-header -->
...
<?php
	$no = 1;
	$sql = mysqli_query($koneksi, "SELECT * FROM l_kategori_acc");
...
?> 
                ...
                <tr>
                  ...
                  <td><a href="?i=<?php echo $_GET['i']?>&page=updt&id=<?php echo $hasil['kategoriacc_id']?>">
                  <button type="button" class="btn btn-success fa fa-edit"> Edit</button></a>
                  <a href="?i=<?php echo md5('d_kategoriacc')?>&id=<?php echo $hasil['kategoriacc_id']?>">
                ...
                <tfoot>
					...
					if(isset($_GET['page'])){
						if($_GET['page'] == 'add'){
							...
							$sp = mysqli_query($koneksi, "SELECT * FROM l_kategori_acc WHERE kategoriacc_id = '$_GET[id]'");
							$hp = mysqli_fetch_array($sp);
							?>
							<tr>
                                <td></td>
                                <td><input type="text" class="form-control" style="width:100%" name="nama" value="<?php echo $hp['kategoriacc_nama']?>" required /></td>
