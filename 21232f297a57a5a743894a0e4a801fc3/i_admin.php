...
if(isset($_POST['simpan'])){
	$qpr = mysqli_query($koneksi, "SELECT * FROM m_user WHERE user_email = '$_POST[email]'");
	$num = mysqli_num_rows($qpr);
	if($num == 0){
		$pass = md5('admin123');
		$rand = rand(100000,999999);
		mysqli_query($koneksi, "INSERT INTO m_user VALUES('', '$_POST[nama]', '$pass', '$_POST[nohp]', '$_POST[email]', 'nothing.png', '$rand', 'verif', '1')");
		?>
		<script>
       ...
       <form action="" method="post">
        ...
        <div class="col-md-6">
                ...
                <div class="input-group date">
                  ...
                  <input type="email" class="form-control" name="email" style="width:50%" placeholder="Isi Disini" required >
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control" onkeyup="error()" style="width:50%" name="nohp" id="nohp" maxlength="20" minlength="8" placeholder="Isi Disini" required > <i id="error" style="color:#E00"></i>
               	</div>
