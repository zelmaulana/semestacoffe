	...
	if ($num == 0) {
		...
		<?php
			...
			<script>
				...
				Swal.fire({
					title: 'E-Mail Yang Anda Masukan Sudah Terdaftar',
					animation: true,
					customClass: {
						popup: 'animated tada'
					},
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<div class="input-group date">
										...
										<input type="email" class="form-control" name="email" value="<?php echo $h1['user_email'] ?>" placeholder="Isi Disini" required>
								...
								<div class="form-group">
									...
									<div class="input-group date">
										...
										<input type="text" class="form-control" onkeyup="error()" value="<?php echo $h1['user_nohp'] ?>" name="nohp" id="nohp" maxlength="20" minlength="8" placeholder="Isi Disini" required> <i id="error" style="color:#E00"></i>
									</div>
