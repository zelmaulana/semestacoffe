...
if(isset($_POST['simpan'])){
	...
	if($diskon < $_POST['harga_beli']){
		...
		if (in_array($x , $val)){
			...
			mysqli_query($koneksi, "INSERT INTO m_barang VALUES ('', '$_POST[judul]','', 'Null', 'Null', '$_POST[stok]', '1', '$_POST[kategori]', '', '',  '$_POST[harga_beli]', '$_POST[harga_jual]', '', '$_POST[diskon]', '', '', '$img', '$_POST[deskripsi]')");
