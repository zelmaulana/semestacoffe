...
if(isset($_POST['simpan'])){
	...
	if($diskon < $_POST['harga_beli']){
		...
		if (in_array($x , $val)){
			...
			mysqli_query($koneksi, "INSERT INTO m_barang VALUES ('', '$_POST[judul]', '$_POST[penerbit]', '$_POST[thn_terbit]', '$_POST[kota_terbit]', '$_POST[stok]', '2', '$_POST[kategori]', '$_POST[penulis]', '$_POST[harga_beli]', '$_POST[harga_jual]', '', '$_POST[diskon]', '$_POST[berat]','', '$img', '$_POST[deskripsi]')");
			?>
			<script>
