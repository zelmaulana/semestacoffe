...
<div class="wrapper">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <h4 style="color:#FFF;margin-top:0.5cm"><center</center></h4>
    </nav>
  </header>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            ...
            <ul class="treeview-menu">
            <li><a href="?i=<?php echo md5('perlu-dikirim')?>"><i class="fa fa-bell"></i>Perlu Dikirim <sup style="color:#FF3"><i class="fa fa-bell"></i> <?php echo $h1?></sup></a></li>
            <li><a href="?i=<?php echo md5('dikirim')?>"><i class="fa fa-bell"></i>Dikirim <sup style="color:#FF3"><i class="fa fa-bell"></i> <?php echo $h2?></sup></a></li>
