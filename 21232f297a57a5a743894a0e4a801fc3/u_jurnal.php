...
if(isset($_POST['simpan'])){
	...
	if($_FILES['file']['size'] == 0){
		if($diskon < $_POST['harga_beli']){
			...
			mysqli_query($koneksi, "UPDATE m_barang SET judul='$_POST[judul]', penerbit_id='$_POST[penerbit]', thn_terbit='$_POST[thn_terbit]', kota_terbit='$_POST[kota_terbit]', stok='$_POST[stok]', kategori_id='$_POST[kategori]', penulis_id='$_POST[penulis]', harga_beli='$_POST[harga_beli]', harga_jual='$_POST[harga_jual]', diskon='$_POST[diskon]', berat='$_POST[berat]', deskripsi = '$_POST[deskripsi]' WHERE brg_id = '$_GET[id]'");
			?>
			<script>
		...
		if($diskon < $_POST['harga_beli']){
			...
			if (in_array($x , $val)){
				...
				mysqli_query($koneksi, "UPDATE m_barang SET judul='$_POST[judul]', penerbit_id='$_POST[penerbit]', thn_terbit='$_POST[thn_terbit]', kota_terbit='$_POST[kota_terbit]', stok='$_POST[stok]', kategori_id='$_POST[kategori]', penulis_id='$_POST[penulis]', harga_beli='$_POST[harga_beli]', harga_jual='$_POST[harga_jual]', diskon='$_POST[diskon]', berat='$_POST[berat]', image='$img', deskripsi = '$_POST[deskripsi]' WHERE brg_id = '$_GET[id]'");
				?>
				<script>
					window.location = "?i=<?php echo md5('v_jurnal')?>";
					alert("Berhasil Disimpan");
						...
						<div class="col-md-5">
							...
							<div class="form-group">
								...
								<div class="input-group date">
									...
									<input type="number" class="form-control" name="thn_terbit" placeholder="Isi Disini" value="<?php echo $hasil['thn_terbit']?>" >
								</div>
							</div>
							<div class="form-group">
								...
								<div class="input-group date">
									...
									<input type="text" class="form-control" name="kota_terbit" placeholder="Isi Disini" value="<?php echo $hasil['kota_terbit']?>" >
								</div>
							</div>
                            <div class="form-group">
								<label>Penulis</label>
						...
						<div class="col-md-4">
                        	<div class="form-group">
								...
								<div class="input-group date">
									...
									<input type="number" class="form-control" name="stok" placeholder="Isi Disini" required value="<?php echo $hasil['stok']?>" >
								</div>
							</div>
                        	<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="input-group date">
									...
									<input type="text" class="form-control" name="diskon" placeholder="Isi Disini" value="<?php echo $hasil['diskon']?>" >
								</div>
							</div>
							<div class="form-group">
								<label>Berat</label>
							...
							<a href="?i=<?php echo md5('v_jurnal')?>"><button type="button" class="btn btn-primary">Cancel</button> </a>
                    	</div>
                        <div class="col-xs-3">
                        	<div class="form-group">
                            ...
                            <div class="form-group">
								...
								<div class="input-group date">
                                    <textarea name="deskripsi" style="width:250px;height:200px" required><?php echo $hasil['deskripsi']?></textarea>
								</div>
							</div>
                        </div>
                    </div>
