	...
	<div class="container">
		<div class="row">
			...
			$sbuku = mysqli_query($koneksi, "SELECT * FROM m_barang a
								  			 LEFT OUTER JOIN l_kategori b on a.kategori_id = b.kategori_id WHERE brg_id = '$_GET[id]'");
								...
								<div class="">
									<div class="single-products">
										<div class="text-center">
											...
											<a href="?i=<?php echo md5('beli') ?>&id=<?php echo $hbuku['brg_id'] ?>" class="btn btn-warning" <?php if ($hbuku['stok'] == 0) {
																																					echo "disabled";
																																				} else {
																																					echo "";
